...
from code.Enemy import Enemy, Enemy3  # Importa o Enemy3
from code.Player import Player

class EntityFactory:

    @staticmethod
    def get_entity(entity_name: str, screen=None):
        match entity_name:
            case 'Level1Bg':
                list_bg = []
            ...
            case 'Enemy3':
                return Enemy3('Enemy3', (WIN_WIDTH + 10, random.randint(40, WIN_HEIGHT - 40)), screen)
